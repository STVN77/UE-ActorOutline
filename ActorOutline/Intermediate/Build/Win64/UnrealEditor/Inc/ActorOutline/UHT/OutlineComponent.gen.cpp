...
#include "ActorOutline/Public/OutlineComponent.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeOutlineComponent() {}
// Cross Module References
	ACTOROUTLINE_API UClass* Z_Construct_UClass_UOutlineComponent();
	ACTOROUTLINE_API UClass* Z_Construct_UClass_UOutlineComponent_NoRegister();
	ACTOROUTLINE_API UEnum* Z_Construct_UEnum_ActorOutline_EOutlineColor();
	ACTOROUTLINE_API UEnum* Z_Construct_UEnum_ActorOutline_EOutlineGroup();
	...
	UPackage* Z_Construct_UPackage__Script_ActorOutline();
// End Cross Module References
	...
	static UEnum* EOutlineColor_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EOutlineColor.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ActorOutline_EOutlineColor, (UObject*)Z_Construct_UPackage__Script_ActorOutline(), TEXT("EOutlineColor"));
		}
		return Z_Registration_Info_UEnum_EOutlineColor.OuterSingleton;
	}
	template<> ACTOROUTLINE_API UEnum* StaticEnum<EOutlineColor>()
	{
		return EOutlineColor_StaticEnum();
	}
	struct Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_ActorOutline,
		nullptr,
		"EOutlineColor",
		"EOutlineColor",
		Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enum_MetaDataParams), Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_ActorOutline_EOutlineColor()
	{
		if (!Z_Registration_Info_UEnum_EOutlineColor.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EOutlineColor.InnerSingleton, Z_Construct_UEnum_ActorOutline_EOutlineColor_Statics::EnumParams);
		}
	...
	static UEnum* EOutlineGroup_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EOutlineGroup.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ActorOutline_EOutlineGroup, (UObject*)Z_Construct_UPackage__Script_ActorOutline(), TEXT("EOutlineGroup"));
		}
		return Z_Registration_Info_UEnum_EOutlineGroup.OuterSingleton;
	}
	template<> ACTOROUTLINE_API UEnum* StaticEnum<EOutlineGroup>()
	{
		return EOutlineGroup_StaticEnum();
	}
	struct Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
#if !UE_BUILD_SHIPPING
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_ActorOutline,
		nullptr,
		"EOutlineGroup",
		"EOutlineGroup",
		Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enumerators,
		RF_Public|RF_Transient|RF_MarkAsNative,
		UE_ARRAY_COUNT(Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enumerators),
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enum_MetaDataParams), Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::Enum_MetaDataParams)
	};
	UEnum* Z_Construct_UEnum_ActorOutline_EOutlineGroup()
	{
		if (!Z_Registration_Info_UEnum_EOutlineGroup.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EOutlineGroup.InnerSingleton, Z_Construct_UEnum_ActorOutline_EOutlineGroup_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_EOutlineGroup.InnerSingleton;
	}
	struct Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
#if !UE_BUILD_SHIPPING
		{ "Comment", "/** DELEGATES */" },
#endif
		{ "ModuleRelativePath", "Public/OutlineComponent.h" },
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_ActorOutline, nullptr, "OnOutlineChanged__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnOutlineChanged_DelegateWrapper(const FMulticastScriptDelegate& OnOutlineChanged)
{
	OnOutlineChanged.ProcessMulticastDelegate<UObject>(NULL);
}
	struct Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/OutlineComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_ActorOutline, nullptr, "OnOutlineDurationFinished__DelegateSignature", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics::Function_MetaDataParams) };
	UFunction* Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
void FOnOutlineDurationFinished_DelegateWrapper(const FMulticastScriptDelegate& OnOutlineDurationFinished)
{
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOutlineComponent_GetOutlineColor_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OutlineComponent_eventGetOutlineColor_Parms, ReturnValue), Z_Construct_UEnum_ActorOutline_EOutlineColor, METADATA_PARAMS(0, nullptr) }; // 3928188338
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UOutlineComponent_SetOutline_Statics::NewProp_NewColor = { "NewColor", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OutlineComponent_eventSetOutline_Parms, NewColor), Z_Construct_UEnum_ActorOutline_EOutlineColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOutlineComponent_SetOutline_Statics::NewProp_NewColor_MetaData), Z_Construct_UFunction_UOutlineComponent_SetOutline_Statics::NewProp_NewColor_MetaData) }; // 3928188338
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOutlineComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UOutlineComponent_GetOutlineColor, "GetOutlineColor" }, // 2976958037
		...
		{ &Z_Construct_UFunction_UOutlineComponent_SetOutline, "SetOutline" }, // 1368203374
		{ &Z_Construct_UFunction_UOutlineComponent_SetOutlineWithDuration, "SetOutlineWithDuration" }, // 1165684610
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OutlineColor = { "OutlineColor", "OnRep_OutlineColor", (EPropertyFlags)0x0010000100000035, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOutlineComponent, OutlineColor), Z_Construct_UEnum_ActorOutline_EOutlineColor, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OutlineColor_MetaData), Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OutlineColor_MetaData) }; // 3928188338
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOutlineComponent_Statics::NewProp_StencilIndices_Key_KeyProp = { "StencilIndices_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UEnum_ActorOutline_EOutlineColor, METADATA_PARAMS(0, nullptr) }; // 3928188338
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineChanged = { "OnOutlineChanged", nullptr, (EPropertyFlags)0x00100000100b0001, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOutlineComponent, OnOutlineChanged), Z_Construct_UDelegateFunction_ActorOutline_OnOutlineChanged__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineChanged_MetaData), Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineChanged_MetaData) }; // 1508869290
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineDurationFinished = { "OnOutlineDurationFinished", nullptr, (EPropertyFlags)0x00100000100b0001, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOutlineComponent, OnOutlineDurationFinished), Z_Construct_UDelegateFunction_ActorOutline_OnOutlineDurationFinished__DelegateSignature, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineDurationFinished_MetaData), Z_Construct_UClass_UOutlineComponent_Statics::NewProp_OnOutlineDurationFinished_MetaData) }; // 842677796
	...
	template<> ACTOROUTLINE_API UClass* StaticClass<UOutlineComponent>()
	{
		return UOutlineComponent::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::EnumInfo[] = {
		{ EOutlineColor_StaticEnum, TEXT("EOutlineColor"), &Z_Registration_Info_UEnum_EOutlineColor, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3928188338U) },
		{ EOutlineGroup_StaticEnum, TEXT("EOutlineGroup"), &Z_Registration_Info_UEnum_EOutlineGroup, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3116017060U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOutlineComponent, UOutlineComponent::StaticClass, TEXT("UOutlineComponent"), &Z_Registration_Info_UClass_UOutlineComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOutlineComponent), 4284110444U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_1522043165(TEXT("/Script/ActorOutline"),
		Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Steven_Desktop_Games_UE_ActorOutline_UnrealProject_Source_ActorOutline_Public_OutlineComponent_h_Statics::EnumInfo));
